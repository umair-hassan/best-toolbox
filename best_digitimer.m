classdef best_digitimer <handle    
    ...
    methods
        ...
        function setManualAmplitude(obj,Intensity,Stimulator)
            ...
            f=figure('Name','Digitimer | BEST Toolbox','numbertitle', 'off','ToolBar', 'none','MenuBar', 'none','WindowStyle', 'normal','Units', 'normal', 'Position', [0.30 0.5 .60 .20],'Resize','off','KeyPressFcn',@(~,~)Done);
