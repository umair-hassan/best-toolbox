...
%                     obj.pr.grid.ColumnSizes=[-1];
        ...
        function pi_multimodal(obj)
            ...
            obj.pi.mm.update=uicontrol( 'Parent', r4 ,'Style','PushButton','String','Update','FontWeight','Bold','HorizontalAlignment','center','Position',[0 0 1 1],'units','normalized') %add stimulator
            obj.pi.mm.update=uicontrol( 'Parent', r4 ,'Style','PushButton','String','Update','FontWeight','Bold','HorizontalAlignment','center')%add condition
            obj.pi.mm.update=uicontrol( 'Parent', r4 ,'Style','PushButton','String','Update','FontWeight','Bold','HorizontalAlignment','center')%Noise masking
            set( r4, 'Widths', [-1 -1 -1]);
            ...
            obj.pi.mm.update=uicontrol( 'Parent', r6 ,'Style','PushButton','String','Update','FontWeight','Bold','HorizontalAlignment','center') %add single pulse
            obj.pi.mm.update=uicontrol( 'Parent', r6 ,'Style','PushButton','String','Update','FontWeight','Bold','HorizontalAlignment','center')%add burst or train
            obj.pi.mm.update=uicontrol( 'Parent', r6 ,'Style','PushButton','String','Update','FontWeight','Bold','HorizontalAlignment','center','Tooltip','Click to add MEP Measurement module')%add paired pulse
            set( r6, 'Widths', [-1 -1 -1]);
