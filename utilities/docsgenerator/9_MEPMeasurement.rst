...
This parameter can also be used to provide range of max and min [min max] e.g. [100 300] uV amplitude as user-defined acceptable range of EMG muscle activity e.g. 10-30% Maximum Voluntary Contraction (MVC) action. 
