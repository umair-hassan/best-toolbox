...
%             obj.bb.eeg_channels=1
%             obj.bb.aux_channels=1
%             obj.bb.spatial_filter_weights=[1 1]
%             obj.bb.triggers_remaining=40
%             
%             setparam(obj.bb.tg, 'STFTSpindle4', 'rms_threshold',  0.1);
%             setparam(obj.bb.tg, 'STFTSpindle4', 'crr_threshold',  0.01);
%             setparam(obj.bb.tg, 'STFTSpindle4', 'sigma_threshold',0.01);
%             
...
%                 end
                %% Disarming
                if obj.best_toolbox.inputs.trial>=2 && (toc(obj.best_toolbox.info.TimerAA)>40.5)
                    obj.bb.configure_time_port_marker([0 8 12]);
                    obj.bb.disarm;
                    obj.bb.manualTrigger;
                    exit_flag=2;
