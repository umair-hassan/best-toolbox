...
%             pause(0.1)
        ...
        function streamfile(obj,Data)
            warning('Data input should be in 1xN, where N corrosponds to samples and 1 corrosponds to Channel');
            warning('Umair have changed the 128 columsn to 1 column double only');
            obj.StreamFromFile=1;
            Data2Stream=Data;
            sz=size(Data2Stream);
