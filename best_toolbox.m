...
%                   for allconds=1:numel(fieldnames(obj.inputs.condsAll))
%                       
%                       
%                       
%                       
%                       
%                       switch obj.inputs.condsAll.(subsref(fieldnames(obj.inputs.condsAll),substruct('{}',{1}))).inputDevice.measure_str
%                           case 'MEP Measurement'
%                               
%                           case 'IOC'
%                           case 'Motor Threshold Hunting'
...
% %                       obj.inputs.condMat(c,obj.inputs.colLabel.outputDevices)=0
% %                       
% %                       obj.inputs.condMat(c,obj.inputs.colLabel.si)=0
%                       
%                       obj.inputs.condMat(c,obj.inputs.colLabel.chLab)=horzcat({({obj.inputs.condsAll.(conds{c,1}).inputDevice.targetChannels{1,:},obj.inputs.condsAll.(conds{c,1}).inputDevice.displayChannels{1,:}})});
% %                       obj.inputs.condMat(i,obj.inputs.colLabel.axesno)={{targetChannels_ax(1,idx_targetChannels),displayChannels_ax{1,:}}};
% %                       obj.inputs.condMat(i,obj.inputs.colLabel.stimMode)={{{'single_pulse'}}};
% %                       obj.inputs.condMat(i,obj.inputs.colLabel.measures)={{char(targetChannels_meas(1,idx_targetChannels)),displayChannels_meas{1,:}}};
%                       
