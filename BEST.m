...
%         pi  %panel_inputs
    ...
    methods
        ...
        function create_main_panel(obj)
            ...
            obj.pmd.select_measure.string={'Multimodal Measurement/Intervention','MEP Measurement','MEP Hotspot Search','MEP Motor Threshold Hunting','MEP Dose Response Curve_sp','EEG triggered Stimulation','TMS fMRI','TEP Measurement','ERP Measurement','rs EEG Analysis','rTMS Interventions'};
...
%                     obj.pr.grid.ColumnSizes=[-1];
        ...
        function pi_multimodal(obj)
            ...
            obj.pi.mm.update=uicontrol( 'Parent', r5 ,'Style','PushButton','String','Update','FontWeight','Bold','HorizontalAlignment','center') %add stimulator
            obj.pi.mm.update=uicontrol( 'Parent', r5 ,'Style','PushButton','String','Update','FontWeight','Bold','HorizontalAlignment','center')%add condition
            obj.pi.mm.update=uicontrol( 'Parent', r5 ,'Style','PushButton','String','Update','FontWeight','Bold','HorizontalAlignment','center')%Noise masking
            set( r5, 'Widths', [-1 -1 -1]);
...
%             obj.pi.mm.update=uicontrol( 'Parent', mep_panel_17 ,'Style','PushButton','String','Update','FontWeight','Bold','HorizontalAlignment','center')%Measure TEP
        ...
        function cb_pi_mm_conditions(obj)
            ...
            ax_panel= uix.Panel( 'Parent',obj.pi.mm.tab  )
            obj.pi.mm.cond.(cd).ax=axes('parent',ax_panel );
            box on; hold on;
...
%             obj.pi.mm.tab.TabTitles=obj.pi.mm.cond.TabNames;
            ...
            obj.pi.mm.cond.(cd).ax.YTickLabel={'','Input Device',''};
        ...
        function cb_pi_mm_stim(obj)
            ...
            obj.pi.mm.stim.(cd).(st).plt=plot([-45 45],[-1*obj.pi.mm.stim.(cd).no -1*obj.pi.mm.stim.(cd).no],'Color','k','parent',obj.pi.mm.cond.(cd).ax,'LineWidth',2); %line
...
%             plot([-45 45],[-2-obj.pi.mm.stim.no -2-obj.pi.mm.stim.no],'Color','k','parent',obj.pi.mm.ax);
        ...
        function cb_pi_mm_pulse(obj,source,event)
            ...
            obj.pi.mm.stim.(cd).(st).pulse_count=obj.pi.mm.stim.(cd).(st).pulse_count+1;
            
            switch source.Tag
                case 'single_pulse'
                    obj.pi.mm.stim.(cd).(st).pulse_types{1,obj.pi.mm.stim.(cd).(st).pulse_count}=cellstr('single_pulse');
                    obj.pi.mm.stim.(st).pulse_specs=text(obj.pi.mm.stim.(cd).(st).pulse_count-0.25,-obj.pi.mm.stim.(cd).slctd+0.41,'TS:[80 90] %MSO','VerticalAlignment','bottom','Color',[0.50 0.50 0.50],'FontSize',7,'FontAngle','italic','UserData',[obj.pi.mm.stim.(cd).(st).pulse_count,obj.pi.mm.stim.(cd).slctd])
                ...
                case 'train'
                    ...
                    obj.pi.mm.stim.(st).pulse_specs=text(obj.pi.mm.stim.(cd).(st).pulse_count,-obj.pi.mm.stim.(cd).slctd+0.4,{'Pulses:[?], f:[?] Hz', 'TS:[?] %MSO'},'VerticalAlignment','bottom','Color',[0.50 0.50 0.50],'FontSize',7,'FontAngle','italic','UserData',[obj.pi.mm.stim.(cd).(st).pulse_count,obj.pi.mm.stim.(cd).slctd])
            ...
            obj.pi.mm.stim.(cd).(st).plt=plot(x,y,'Color','k','parent',obj.pi.mm.cond.(cd).ax,'LineWidth',2); %line
            
            obj.cb_pi_mm_pulseboxes;
...
%            ------------------------->>>> uncomment the function and paste from some of the tab the correctly written function and test
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %         function cb_pi_mm_pulse(obj,source,event)
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             obj.pi.mm.stim.slctd=2;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %            
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                     obj.pi.mm.stim.(st).pulse_specs=text(obj.pi.mm.stim.(st).pulse_count-0.25,-obj.pi.mm.stim.slctd+0.41,'TS:[80 90] %MSO','VerticalAlignment','bottom','Color',[0.50 0.50 0.50],'FontSize',7,'FontAngle','italic','UserData',[obj.pi.mm.stim.(st).pulse_count,obj.pi.mm.stim.slctd])
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                     p1 = [1.15 -1.1];                         % First Point
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                     p2 = [2 -1.1];                         % Second Point
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                     dp = p2-p1;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                     quiver(p1(1),p1(2),dp(1),dp(2),0)
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                     obj.pi.mm.stim.(st).pulse_specs=text(obj.pi.mm.stim.(st).pulse_count-0.25,-obj.pi.mm.stim.slctd+0.4,{'TS:[?], CS:[?] %MSO', 'ISI:[?] ms'},'VerticalAlignment','bottom','Color',[0.50 0.50 0.50],'FontSize',7,'FontAngle','italic','UserData',[obj.pi.mm.stim.(st).pulse_count,obj.pi.mm.stim.slctd])
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                 case 'train'
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                    obj.pi.mm.stim.(st).pulse_types{1,obj.pi.mm.stim.(st).pulse_count}=cellstr('train');
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                    obj.pi.mm.stim.(st).pulse_specs=text(obj.pi.mm.stim.(st).pulse_count,-obj.pi.mm.stim.slctd+0.4,{'Pulses:[?], f:[?] Hz', 'TS:[?] %MSO'},'VerticalAlignment','bottom','Color',[0.50 0.50 0.50],'FontSize',7,'FontAngle','italic','UserData',[obj.pi.mm.stim.(st).pulse_count,obj.pi.mm.stim.slctd])
...
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                         disp sp
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                         x{i}=([i i i+0.15 i+0.15]);
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                         y{i}=[-obj.pi.mm.stim.slctd -obj.pi.mm.stim.slctd+0.4 -obj.pi.mm.stim.slctd+0.4 -obj.pi.mm.stim.slctd];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                     case 'paired_pulse'
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                         disp pp
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                         x{i}=[i i i+0.15 i+0.15 i+0.25 i+0.25 i+0.40 i+0.40];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                         y{i}=[-obj.pi.mm.stim.slctd -obj.pi.mm.stim.slctd+0.20 -obj.pi.mm.stim.slctd+0.20 -obj.pi.mm.stim.slctd -obj.pi.mm.stim.slctd -obj.pi.mm.stim.slctd+0.4 -obj.pi.mm.stim.slctd+0.4 -obj.pi.mm.stim.slctd];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                     case 'train'
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                         disp train
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                         %                         x(i)=[i i i+0.20 i+0.20 i+0.30 i+0.30 i+0.50 i+0.50 i+0.60 i+0.60 i+0.80 i+0.80];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                         x{i}=[i i i+0.15 i+0.15 i+0.25 i+0.25 i+0.40 i+0.40 i+0.50 i+0.50 i+0.65 i+0.65];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                         y{i}={[-obj.pi.mm.stim.slctd -obj.pi.mm.stim.slctd+0.5 -obj.pi.mm.stim.slctd+0.5 -obj.pi.mm.stim.slctd -obj.pi.mm.stim.slctd -obj.pi.mm.stim.slctd+0.5 -obj.pi.mm.stim.slctd+0.5 -obj.pi.mm.stim.slctd]};
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % 
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                         y{i}=-obj.pi.mm.stim.slctd+[0 0.4 0.4 0 0 0.4 0.4 0 0 0.4 0.4 0];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                 end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             end
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             x=[-45 cell2mat(x) 45];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             y=[-obj.pi.mm.stim.slctd cell2mat(y) -obj.pi.mm.stim.slctd];
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             obj.pi.mm.stim.((st)).plt=plot(x,y,'Color','k','parent',obj.pi.mm.ax,'LineWidth',2); %line
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             obj.cb_pi_mm_pulseboxes;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             drawArrow = @(x,y) quiver( x(1),y(1),x(2)-x(1),y(2)-y(1),0,'color','k' )
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             obj.pi.mm.stim.(st).pulse_time=text(obj.pi.mm.stim.(st).pulse_count-1+0.5,-obj.pi.mm.stim.slctd-0.05,'t:? ms','VerticalAlignment','top','Color',[0.50 0.50 0.50],'FontSize',9,'FontAngle','italic','UserData',[obj.pi.mm.stim.(st).pulse_count,obj.pi.mm.stim.slctd])
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             obj.pi.mm.stim.(st).pulse_arrow1=drawArrow([obj.pi.mm.stim.(st).pulse_count-1 obj.pi.mm.stim.(st).pulse_count-1+1],[-obj.pi.mm.stim.slctd-0.05 -obj.pi.mm.stim.slctd-0.05])
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             obj.pi.mm.stim.(st).pulse_arrow2=drawArrow([obj.pi.mm.stim.(st).pulse_count-1+1 obj.pi.mm.stim.(st).pulse_count-1],[-obj.pi.mm.stim.slctd-0.05 -obj.pi.mm.stim.slctd-0.05])
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             if(obj.pi.mm.ax.XLim(2)<obj.pi.mm.stim.(st).pulse_count+1)
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %                 obj.pi.mm.ax.XLim(2)=obj.pi.mm.stim.(st).pulse_count+1;
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %             end
...
% % % % %         end
        ...
        function pi_mep(obj)
            ...
            %threshold vala section usi hisab se phir enable off hona
            %chahye, jese he mt pe click ho to ye on ho jaye otherwise off
            %rahy
        ...
        function cb_measure_listbox(obj)
            ...
            switch obj.info.event.current_measure
                ...
                case 'rTMS Interventions'
                    obj.pi_rtms_train
                case 'Multimodal Measurement/Intervention'
                    obj.pi_multimodal;
            end
