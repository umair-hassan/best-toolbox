...
%             obj.pr.axesno=3;
        ...
        function pr_mep(obj)
            ...
            ax_no=['ax' num2str(obj.pr.axesno)];

            obj.pr.clab.(ax_no)=uix.Panel( 'Parent', obj.pr.grid, 'Padding', 5 ,'Units','normalized','Title', 'MEP Measurement','FontWeight','bold','FontSize',12,'TitlePosition','centertop' );
                        
            mep1_vb=uix.VBox( 'Parent',  obj.pr.clab.(ax_no), 'Spacing', 5, 'Padding', 1  );
            
            mep1_r1 = uix.HBox( 'Parent', mep1_vb, 'Spacing', 5, 'Padding', 1  );
            uiextras.HBox( 'Parent', mep1_r1)
            obj.pr.current_mep_label.(ax_no)=uicontrol( 'Style','text','Parent', mep1_r1,'String','Current MEP Amp','FontSize',11,'HorizontalAlignment','center','Units','normalized');
            obj.pr.current_mep.(ax_no)=uicontrol( 'Style','edit','Parent', mep1_r1,'FontSize',11,'HorizontalAlignment','center','Units','normalized');
            obj.pr.mean_mep_label.(ax_no)=uicontrol( 'Style','text','Parent', mep1_r1,'String','Mean MEP Amp','FontSize',11,'HorizontalAlignment','center','Units','normalized');
            obj.pr.mean_mep.(ax_no)=uicontrol( 'Style','edit','Parent', mep1_r1,'FontSize',11,'HorizontalAlignment','center','Units','normalized');
            uiextras.HBox( 'Parent', mep1_r1)
            set(mep1_r1,'Widths',[-0.3 130 70 130 70 -0.3])

            mep1_r2 = uix.HBox( 'Parent', mep1_vb, 'Spacing', 5, 'Padding', 1  );
            obj.pr.ax.(ax_no)=axes( 'Parent',  mep1_r2,'Units','normalized');
