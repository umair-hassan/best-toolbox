classdef best_toolbox_gui_version_inprogress_testinlab_2910_sim < handle
    ...
    methods
        ...
        function obj= best_toolbox_gui_version_inprogress_testinlab_2910_sim (app)
            %put app in the argument of this above func declreation
            % obj.info.axes.mepp=app
% %             load sim_mep.mat;
            obj.app=app
% %             obj.sim_mep=sim_mep';
        ...
        function best_mep(obj)
            ...
            %  obj.info.axes.rmt=findobj( panelhandle,'Type','axes','Tag','rmt')
            obj.best_trialprep;
...
% % % % % % % % %                 obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).rawdata(obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).info.trial,:)=rand*(obj.sim_mep(1,1:NumSamp))*(obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).trials((obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).info.trial),1));
        ...
        function best_mt_plot(obj)
            ...
            if(obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).info.trial==1)
                ...
                obj.info.handles.mt_plot=plot(obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).trials(1,1),'Parent',obj.info.axes.mt,'LineWidth',2);
            ...
            set(obj.info.handles.mt_plot,'YData',(obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).trials(2:obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).info.trial_plotted+1,1)))
        ...
        function best_mep_stats(obj)
            ...
            obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).results.mep_stats(:,8)=(obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).results.mep_stats(:,4))/sqrt(obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).info.ioc.trialsperSI);    %TODO: Make it modular by replacing 15 to # trials per intensity object value
        ...
        function best_ioc_plot(obj)
            ...
            plot([obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).info.pt_x,SI_min_point],[pt_y,pt_y],'--','Color' , [0.75 0.75 0.75]);
            plot([obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).info.pt_x,obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).info.pt_x],[pt_y,seet],'--','Color' , [0.75 0.75 0.75]);
            ...
            if(strcmp(obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).inputs.stim_mode,'MT'))
                ...
                disp('error is here');
                plot([obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).info.th,SI_min_point],[0.05,0.05],'--','Color' , [0.75 0.75 0.75]);
                plot([obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).info.th,obj.sessions.(obj.inputs.current_session).(obj.inputs.current_measurement).info.th],[0.05,seet],'--','Color' , [0.75 0.75 0.75]);
