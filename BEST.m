...
%                     obj.pr.grid.ColumnSizes=[-1];
        ...
        function pi_multimodal(obj)
            ...
            obj.pi.mm.cond=uicontrol( 'Parent', r4 ,'Style','PushButton','String','Cond','FontWeight','Bold','HorizontalAlignment','center')%add condition
...
%             obj.pi.mm.update=uicontrol( 'Parent', mep_panel_17 ,'Style','PushButton','String','Update','FontWeight','Bold','HorizontalAlignment','center')%Measure TEP
            ...
            obj.pi.mm.ax=axes('parent',obj.pi.mm.r0v2 );
            box on
            obj.pi.mm.ax.YLim=[-1 1];
            obj.pi.mm.ax.XLim=[-2 4];
            xticks(obj.pi.mm.ax,[100 101]);
            yticks(obj.pi.mm.ax,[-1:1:1])

%             obj.pi.mm.ax.YTickLabel={'','Stimulator 1','Input Device',''};
            obj.pi.mm.ax.YTickLabel={'','Input Device',''};
...
%             plot([-45 45],[-2 -2],'Color','k','parent',obj.pi.mm.ax);
        ...
        function cb_pi_mm_stim(obj)
            obj.pi.mm.stim.no=obj.pi.mm.stim.no+1;
            st=['st' num2str(obj.pi.mm.stim.no)];
            axes(obj.pi.mm.ax)
            hold on;
            %             plot([-45 45],[1 1],'Color','k','parent',obj.pi.mm.ax);
...
%             plot([-45 45],[-2-obj.pi.mm.stim.no -2-obj.pi.mm.stim.no],'Color','k','parent',obj.pi.mm.ax);
            ...
            text(-2,-1*obj.pi.mm.stim.no,'click to add device','VerticalAlignment','bottom','Color',[0.50 0.50 0.50],'FontSize',9,'FontAngle','italic','Tag',num2str(obj.pi.mm.stim.no),'ButtonDownFcn',@obj.mm_add_stim)
            obj.pi.mm.ax.YTickLabel

        end
        function cb_pi_mm_pulse(obj,source,event)
            obj.pi.mm.stim.slctd=4;
            ...
            obj.pi.mm.stim.(st).pulse_count=obj.pi.mm.stim.(st).pulse_count+1;
             ...
             switch source.Tag
                case 'single_pulse'
                    ...
                    text(obj.pi.mm.stim.(st).pulse_count-0.25,-obj.pi.mm.stim.slctd+0.51,'TS:[80 90] %MSO','VerticalAlignment','bottom','Color',[0.50 0.50 0.50],'FontSize',9,'FontAngle','italic','UserData',[obj.pi.mm.stim.(st).pulse_count,obj.pi.mm.stim.slctd])
...
% annotation('textarrow',[1 2],[-1.1 -1.1],'String','t:?','Units','points');
                ...
                case 'paired_pulse'
                    ...
                    text(obj.pi.mm.stim.(st).pulse_count-0.25,-obj.pi.mm.stim.slctd+0.5,{'TS:[?], CS:[?] %MSO', 'ISI:[?] ms'},'VerticalAlignment','bottom','Color',[0.50 0.50 0.50],'FontSize',9,'FontAngle','italic','UserData',[obj.pi.mm.stim.(st).pulse_count,obj.pi.mm.stim.slctd])
            ...
            for i=1:obj.pi.mm.stim.(st).pulse_count
                switch char(obj.pi.mm.stim.(st).pulse_types{1,i})
                    ...
                    case 'paired_pulse'
                        ...
                        y{i}=[-obj.pi.mm.stim.slctd -obj.pi.mm.stim.slctd+0.25 -obj.pi.mm.stim.slctd+0.25 -obj.pi.mm.stim.slctd -obj.pi.mm.stim.slctd -obj.pi.mm.stim.slctd+0.5 -obj.pi.mm.stim.slctd+0.5 -obj.pi.mm.stim.slctd];
                    case 'train'
                        disp train
...
%                         y{i}={[-obj.pi.mm.stim.slctd -obj.pi.mm.stim.slctd+0.5 -obj.pi.mm.stim.slctd+0.5 -obj.pi.mm.stim.slctd -obj.pi.mm.stim.slctd -obj.pi.mm.stim.slctd+0.5 -obj.pi.mm.stim.slctd+0.5 -obj.pi.mm.stim.slctd]};
                        ...
                        y{i}=-obj.pi.mm.stim.slctd+[0 0.5 0.5 0 0 0.5 0.5 0 0 0.5 0.5 0];
                end
            end
            ...
            text(obj.pi.mm.stim.(st).pulse_count+0.5,-obj.pi.mm.stim.slctd-0.05,'t:? ms','VerticalAlignment','top','Color',[0.50 0.50 0.50],'FontSize',9,'FontAngle','italic','UserData',[obj.pi.mm.stim.(st).pulse_count,obj.pi.mm.stim.slctd])
            
            drawArrow([obj.pi.mm.stim.(st).pulse_count obj.pi.mm.stim.(st).pulse_count+1],[-obj.pi.mm.stim.slctd-0.05 -obj.pi.mm.stim.slctd-0.05])
            drawArrow([obj.pi.mm.stim.(st).pulse_count+1 obj.pi.mm.stim.(st).pulse_count],[-obj.pi.mm.stim.slctd-0.05 -obj.pi.mm.stim.slctd-0.05])
