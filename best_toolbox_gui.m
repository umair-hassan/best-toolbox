classdef best_toolbox_gui < handle
    %%
    % %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %
    % BEST Toolbox class
    ...
    methods
        ...
        function obj= best_toolbox_gui (app)
        ...
        function best_mep(obj)
            ...
            obj.ap=findobj( panelhandle,'Type','axes','Tag','mep')
            obj.ar=findobj( panelhandle,'Type','axes','Tag','rmt')
        ...
        function best_ioc(obj)
            ...
            panelhandle=findobj(figHandle,'Type','axes')
            obj.ap=findobj( panelhandle,'Type','axes','Tag','mep')
            obj.aioc=findobj( panelhandle,'Type','axes','Tag','ioc')
            obj.aioc_fit=findobj( panelhandle,'Type','axes','Tag','ioc_fit')
        ...
        function best_mep_plot(obj)
            ...
            axes(obj.ap)
            set(obj.ap,'FontSize',obj.data.(obj.info.str).inputs.FontSize)
            %             ap.Units='normalized'
            ...
            if (obj.info.trial_plotted==1)
                ...
                obj.info.handles.current_mep_plot=plot(obj.info.timevector,obj.data.(obj.info.str).outputs.rawdata(obj.info.trial_plotted,:),'Color',[1 0 0],'LineWidth',2,'Parent',obj.ap);
                hold on;
                ylim([obj.data.(obj.info.str).inputs.ylim_min obj.data.(obj.info.str).inputs.ylim_max])
                ...
                yticks(obj.data.(obj.info.str).inputs.ylim_min:1000:obj.data.(obj.info.str).inputs.ylim_max)
                % obj.ap.FontSize=obj.data.(obj.info.str).inputs.FontSize;
                
                % legend(obj.info.handles.current_mep_plot,'Current MEP');
                
                % Create xlabel
                xlabel('Time (ms)','FontSize',obj.data.(obj.info.str).inputs.FontSize,'FontName','Arial');
                % Create ylabel
                ylabel('EMG Potential (\mu V)','FontSize',obj.data.(obj.info.str).inputs.FontSize,'FontName','Arial');
            ...
            elseif (obj.info.trial_plotted==2)
                ...
                obj.info.handles.past_mep_plot=plot(obj.info.timevector,obj.data.(obj.info.str).outputs.rawdata(obj.info.trial_plotted,:),'Color',[0.75 0.75 0.75],'Parent',obj.ap);
                hold on;
                obj.info.handles.mean_mep_plot=plot(obj.info.timevector,mean(obj.data.(obj.info.str).outputs.rawdata),'color',[0,0,0],'LineWidth',1.5,'Parent',obj.ap);
                hold on;
              ...
              %  h_legend=[obj.info.handles.past_mep_plot; obj.info.handles.mean_mep_plot; obj.info.handles.current_mep_plot];
                ...
                obj.info.handles.prev_mep_plot=animatedline(obj.ap,obj.info.timevector,obj.data.(obj.info.str).outputs.rawdata(obj.info.trial_plotted-1,:),'color',[0.75 0.75 0.75]);
        ...
        function best_mt_plot(obj)
            axes(obj.ar)
                        obj.ar.FontSize=obj.data.(obj.info.str).inputs.FontSize

            if(obj.info.trial==1)
                %  obj.info.handles.mt_figure=figure('name','Motor Thresholding, MEP Amp Trace');
                
                obj.info.handles.mt_plot=plot(obj.data.(obj.info.str).outputs.trials(1,1),'Parent',obj.ar);
                %       obj.info.handles.mt_plot=plot(obj.data.(obj.info.str).outputs.trials(1,1));
                
                xlabel('Trial Number','FontSize',obj.data.(obj.info.str).inputs.FontSize);   %TODO: Put if loop of RMT or MSO
                
                % Create ylabel
                ylabel('Stimulation Intensities (%MSO)','FontSize',obj.data.(obj.info.str).inputs.FontSize);
                ...
                % Create title
%                 title({'Threshold Hunting - Stimulation Intensities Trace'},'FontWeight','bold','FontSize',obj.data.(obj.info.str).inputs.FontSize,'FontName','Calibri');
                set(gcf, 'color', 'w')
            end
...
bg = gca; legend(bg,'off');
        ...
        function best_ioc_scatplot(obj)
                        axes(obj.aioc)
                                    set(obj.aioc,'FontSize',obj.data.(obj.info.str).inputs.FontSize)


            if(obj.info.trial==1)
             %   obj.info.handles.ioc_scatplot_fig=figure('name','IOC - MEP Amp Scatter Plot');
                
                obj.info.handles.ioc_scatplot=plot(obj.data.(obj.info.str).outputs.trials(1,1),obj.data.(obj.info.str).outputs.trials(1,4),'o','Color','r','MarkerSize',8,'MarkerFaceColor','r');
                hold on;
                xlabel('Stimulation Intensities','FontSize',obj.data.(obj.info.str).inputs.FontSize);   %TODO: Put if loop of RMT or MSO
                
                % Create ylabel
                ylabel('MEP P2P Amplitude','FontSize',obj.data.(obj.info.str).inputs.FontSize);
           ...
           if (obj.info.trial>1)
            ...
            obj.info.handles.ioc_scatplot=plot(obj.data.(obj.info.str).outputs.trials(obj.info.trial_plotted,1),obj.data.(obj.info.str).outputs.trials(obj.info.trial_plotted,4),'o','MarkerSize',8,'Color','r','MarkerFaceColor','r');
            hold on;
